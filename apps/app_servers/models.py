...
class Server(models.Model):
    zctype = models.ForeignKey('app_servers.ServerType', on_delete=models.CASCADE)
    ...
    owner = models.ForeignKey('app_users.UserProfile', on_delete=models.SET_NULL, null=True, blank=True)
